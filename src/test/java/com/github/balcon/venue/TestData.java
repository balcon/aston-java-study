...
public final class TestData {
    ...
    public static final BandWriteDto BAND_WRITE_DTO = BandWriteDto.builder()
            .name("Name").build();
    ...
    public static final EventWriteDto EVENT_WRITE_DTO = EventWriteDto.builder()
            .name("Name")
    ...
    public static final MusicianWriteDto MUSICIAN_WRITE_DTO = MusicianWriteDto.builder()
            .name("Name")
            .role("Role")
